...
//Includes
use vendor\lipseys\apiintegration\src\LipseysClient;
...
class Products{
    ...
    public function __construct()
    {
        ...
        $this->lipseysApi = new LipseysClient();
    ...
    */
    ...
    /**
     * Get all Products From LipseysAPI
    */
    public function getAll_API_Products(){
        $catalog = $this->lipseysApi->Catalog();
        return $catalog;
    }
    ...
    */
    ...
    public function validate_Lipseys_Product($productNumber){
        ...
        $result = $this->lipseysApi->ValidateItem($productNumber);
    ...
    */
     ...
     */
    public function process(&$billingDetails, &$shippingDetails, &$paymentDetails, &$cart){
    ...
    public function lipseysOrder(&$shippingInformation, &$billingData, $ordertype){
        ...
        if($ordertype == "firearms"){
            ...
            $this->lipseysApi->DropShipFirearms($firearmOder);
            ...
            $this->lipseysApi->DropShipAccessories($accessoryOder);
            ...
            $result = $this->lipseysApi->Order($nonDropshipOder);
