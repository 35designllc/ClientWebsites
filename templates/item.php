                ...
                <div class="shopItemDescription">
                    ...
                    <div class="shopItemPriceQtyBox">
                        ...
                        <?php if($qty > 0):?>
                            <?php if($item[0]->ONSALE == "TRUE"): ?>
                                <p class="shopItemPrice" style="color:red;">SALE! $<?php echo number_format((float)$price, 2, '.', ''); ?></p>
                            <?php else: ?>
                                <p class="shopItemPrice">$<?php echo number_format((float)$price, 2, '.', ''); ?></p>
                            <?php endif; ?>
                        <?php else: ?>
                            <?php if($item[0]->ONSALE == "TRUE"): ?>
                                <p class="shopItemPrice" style="color:red;">SALE! $<?php echo number_format((float)$item[0]->PRICE, 2, '.', ''); ?></p>
                            <?php else: ?>
                                <p class="shopItemPrice">$<?php echo number_format((float)$item[0]->PRICE, 2, '.', ''); ?></p>
                            <?php endif; ?>
                        <?php endif; ?>
                        </div>
                        <div class="shopItemQtyBox">
                            ...
                            <script>
                                function changeQty(val){
                                    document.getElementById("qtySub").value = val;
                                }
                            </script>
                        </div>
                    </div>
                    <div class="shopItemButtonsBox">
                        <form action="redirectCt.php" method="post">
                            ...
                            <?php endif;?>
                            <input type="hidden" id="qtySub" name="quantity"/>
                        ...
                        <form action="redirectChck.php" method="post">
                            ...
                            <?php endif;?>
                            <input type="hidden" id="qtySub" name="quantity"/>
                            <button class="SIB" value="add to cart">buy now</button>
                        </form>
                    </div>
                                    ...
                                    <a class="link" href="item.php?itemNo=<?php echo $Related[$randItem]->ITEMNO;?>">
                                        ...
                                        <div class="productDescBox">
                                            ...
                                            <div class="productPrice acPr">
                                                $<?php echo number_format((float)$Related[$randItem]->PRICE, 2, '.', ''); ?>
                                            </div>
                                        </div>
                                    </a>
                                </div>
