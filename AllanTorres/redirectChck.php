...
if(isset($BD)){ #&& isset($CCD)){
    ...
    if(isset($FSD)){
        ...
        #$FA_result = $product->process($billingData, $firearmShippingData, $creditCardData);
    
        #if($FA_result === true){
        #$FA_result = $product->lipseysOrder($firearmShippingData, $billingData, "firearms");
        $FA_result = TRUE;
    ...
    if(isset($ASD)){
        ...
        #if($ACC_result === true){
        #$ACC_result = $product->lipseysOrder($accessoryShippingData, $billingData, "accessories");
        $ACC_result = TRUE;
    ...
    if(isset($NDSD)){
        ...
        #if($ND_result === true){
        #$ND_result = $product->lipseysOrder($nonDropshipShippingData, $billingData, "nonDropShip");
        $ND_result = TRUE;
